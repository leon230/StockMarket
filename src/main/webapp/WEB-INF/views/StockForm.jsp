...
<body>
	<div class="container">
        <h1>Buying: ${walletItemStockName}</h1>
            ...
            <form:errors path="*" class="errorblock" element="div"/>
                ...
                <spring:bind path="walletItemStockName">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <form:input path="walletItemStockName" type="text" class="form-control" id="walletItemStockName" placeholder="Stock name" disabled="true"/>
